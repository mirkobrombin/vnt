          ...
          <StaticNotebook context="mainMenu">
            ...
            <Showcase title="Button" description="A component to trigger actions">
              <HBox :spacing="15">
                ...
                <Button label="Suggested Action" @click="console.log('ciao')" icon="check" type="suggested" />
                <Button label="Destructive Action" @click="console.log('ciao')" icon="close" type="destructive" />
              </HBox>
            </Showcase>
